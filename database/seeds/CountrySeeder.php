...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('countries')->insert(['name' => 'Antarctica']);
        ...
        DB::table('countries')->insert(['name' => 'Democratic Republic of the Congo']);
        DB::table('countries')->insert(['name' => 'Republic of Congo']);
        DB::table('countries')->insert(['name' => 'Cook Islands']);
        DB::table('countries')->insert(['name' => 'Costa Rica']);
        DB::table('countries')->insert(['name' => 'Croatia (Hrvatska)']);
        ...
        DB::table('countries')->insert(['name' => 'East Timor']);
        ...
        DB::table('countries')->insert(['name' => 'Falkland Islands (Malvinas)']);
        ...
        DB::table('countries')->insert(['name' => 'France, Metropolitan']);
        ...
        DB::table('countries')->insert(['name' => 'Heard and Mc Donald Islands']);
        ...
        DB::table('countries')->insert(['name' => 'Iran (Islamic Republic of)']);
        ...
        DB::table('countries')->insert(['name' => 'Ivory Coast']);
        DB::table('countries')->insert(['name' => 'Jersey']);
        ...
        DB::table('countries')->insert(['name' => 'Korea, Democratic Peoples Republic of']);
        DB::table('countries')->insert(['name' => 'Korea, Republic of']);
        DB::table('countries')->insert(['name' => 'Kosovo']);
        DB::table('countries')->insert(['name' => 'Kuwait']);
        DB::table('countries')->insert(['name' => 'Kyrgyzstan']);
        DB::table('countries')->insert(['name' => 'Lao Peoples Democratic Republic']);
        ...
        DB::table('countries')->insert(['name' => 'Libyan Arab Jamahiriya']);
        ...
        DB::table('countries')->insert(['name' => 'Macau']);
        DB::table('countries')->insert(['name' => 'North Macedonia']);
        ...
        DB::table('countries')->insert(['name' => 'Marshall Islands']);
        ...
        DB::table('countries')->insert(['name' => 'Micronesia, Federated States of']);
        ...
        DB::table('countries')->insert(['name' => 'Netherlands Antilles']);
        ...
        DB::table('countries')->insert(['name' => 'Northern Mariana Islands']);
        ...
        DB::table('countries')->insert(['name' => 'Palestine']);
        ...
        DB::table('countries')->insert(['name' => 'South Georgia South Sandwich Islands']);
        DB::table('countries')->insert(['name' => 'South Sudan']);
        DB::table('countries')->insert(['name' => 'Spain']);
        DB::table('countries')->insert(['name' => 'Sri Lanka']);
        DB::table('countries')->insert(['name' => 'St. Helena']);
        DB::table('countries')->insert(['name' => 'St. Pierre and Miquelon']);
        DB::table('countries')->insert(['name' => 'Sudan']);
        DB::table('countries')->insert(['name' => 'Suriname']);
        DB::table('countries')->insert(['name' => 'Svalbard and Jan Mayen Islands']);
        ...
        DB::table('countries')->insert(['name' => 'Tanzania, United Republic of']);
        ...
        DB::table('countries')->insert(['name' => 'United States minor outlying islands']);
        ...
        DB::table('countries')->insert(['name' => 'Virgin Islands (U.S.)']);
        DB::table('countries')->insert(['name' => 'Wallis and Futuna Islands']);
